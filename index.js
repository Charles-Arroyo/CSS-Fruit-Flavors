...
document.getElementById('submitPreferences').addEventListener('click', function() {
    ...
    const favFruit = document.getElementById('favFruit').value;
    const modePreference = document.getElementById('modePreference').value;
    const edgeStyle = document.getElementById('edgeStyle').value;
    favouriteMovieGenre(movieGenre);
    favouriteFruit(favFruit);
    favouriteMode(modePreference);
    favouriteEdgeStyle(edgeStyle);
});
